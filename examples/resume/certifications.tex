...
%---------------------------------------------------------
  \cventry
    ...
    {
    \begin{center}
    \href{https://open.sap.com/verify/xocis-tyvip-gynuh-byneg-punel}{\includegraphics[scale=0.50]{badges/java1_open_badge}}
	\hspace{0.5cm}
	\href{https://open.sap.com/verify/xosen-nykel-vybup-susig-sihim}{\includegraphics[scale=0.50]{badges/cp5_open_badge}}          
	\hspace{0.5cm}
	\href{https://open.sap.com/verify/xuhes-rimus-bikon-roper-hicom}{\includegraphics[scale=0.50]{badges/hcp2-1_open_badge}}                 
	\hspace{0.5cm} 	
	\href{https://open.sap.com/verify/xulor-nynoz-soped-muvuv-zitek}
{\includegraphics[scale=0.50]{badges/hcp1-1_open_badge}}
	\hspace{0.5cm}
	\href{https://open.sap.com/verify/xicav-sakyr-fopyh-kyfal-tunah}{\includegraphics[scale=0.50]{badges/mobile3_open_badge.png}}
	\hspace{0.5cm}
	\href{https://open.sap.com/verify/xifiv-cudur-zycub-tymav-susog}		
{\includegraphics[scale=0.50]{badges/ai1_open_badge}} 
	\hspace{0.5cm}
	\href{https://open.sap.com/verify/xicat-cozod-zopup-hodiz-kucum}
{\includegraphics[scale=0.50]{badges/fiori-ea1_open_badge.png}} 
	\hspace{0.5cm}
	\href{https://open.sap.com/verify/xobec-vunap-temil-bomut-dyran}
{\includegraphics[scale=0.50]{badges/ds3_open_badge}}
	\hspace{0.5cm}
	\href{https://open.sap.com/verify/xodag-zabeh-bapar-ryzaf-tenak}
{\includegraphics[scale=0.50]{badges/btpma1_open_badge.png}}  
    \end{center}   
    }
    \vspace{-0.1cm}
