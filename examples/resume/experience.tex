...
%---------------------------------------------------------
  \cventry
    {Team Lead \& ASP.NET Core and Angular Developer @Finances \& Investment Sector %@Symbiotics
    } % Job title
    ...
    {April 2021 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		...
		\textcolor{rainbowcolor-olive}{Visual Studio 2019/2022}, 
		...
		\textcolor{rainbowcolor-indigo}{ASP.NET (Standard 2 \& Core LTS 2.1-6)}, 
		\textcolor{rainbowcolor-indigo}{Angular 7/8/10/11/12}, 	
  ...
  \cventry
    ...
    {Aug. 2020 - April 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		...
		%\textcolor{rainbowcolor-olive}{MS Teams}, 
		%\textcolor{rainbowcolor-olive}{MS Office Suite}, 
		\textcolor{rainbowcolor-indigo}{ASP.NET (Standard 2 \& .NET Core LTS 2.1-3.1 and 5}, 
		\textcolor{rainbowcolor-indigo}{Node.js}, 
...
Perfective and corrective software maintenance in the integration of an Azure AD (AAD) login functionality within a vacation management online solution, Aka Y.}
		...
		\textcolor{rainbowcolor-indigo}{T-SQL},
		\textcolor{rainbowcolor-indigo}{PL-SQL}, 
		\textcolor{rainbowcolor-indigo}{ASP.NET (MVC 5.0 \& Standard)}, 
