...
%---------------------------------------------------------
  \cventry
    {Team Lead \& .NET (Standard \& Core) and Angular Developer @Finances \& Investment Sector %@Symbiotics
    } % Job title
    ...
    {April 2021 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		...
		\textcolor{rainbowcolor-indigo}{ASP .NET (Standard 2 \& core 2.1 (LTS), 3.1 (LTS) and 6)}, 
  ...
  \cventry
    ...
    {Aug. 2020 - April 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		...
		%\textcolor{rainbowcolor-olive}{MS Teams}, 
		%\textcolor{rainbowcolor-olive}{MS Office Suite}, 
		\textcolor{rainbowcolor-indigo}{ASP .NET (Standard 2 \& .NET core 2.1 (LTS), 3.1 (LTS) and 5}, 
		\textcolor{rainbowcolor-indigo}{Node.js}, 
